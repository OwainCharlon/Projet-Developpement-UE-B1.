...
void ppas ()
{
    ...
    printf("%s", "  des billes d'argiles dans le fond pour drainer l'eau lors de l'arrosage. Là vous pourrez y\n");
...
void ajout_plante()
{
    ...
    printf("%s", "      Prenons les choses a la base, et entrez le nom de votre plante (sans espaces, 20 caractères maximum) :\n");
    scanf("%s", &nom_plante);
